...
activities = {
    ...
    "Soccer Team": {
        "description": "Team-based soccer training with matches and practice drills",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Build skills in shooting, defense, and teamwork on the court",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore scientific concepts in group projects",
